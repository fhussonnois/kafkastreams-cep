...
public interface WrappedStateStore extends StateStore {
    ...
    abstract class AbstractStateStore implements org.apache.kafka.streams.state.internals.WrappedStateStore {
        ...
        public AbstractStateStore(StateStore inner) {
        ...
        public StateStore inner() {
            if (innerState instanceof org.apache.kafka.streams.state.internals.WrappedStateStore) {
                return ((org.apache.kafka.streams.state.internals.WrappedStateStore) innerState).inner();
            }
            return innerState;
        }
